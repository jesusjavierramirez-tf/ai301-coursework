...
I have experience with C, C++, Java, Python, JavaScript, and working with Git and GitHub. I have also worked on AI and software projects, including Python-based machine learning and backend development. I would like to get more experience contributing to an existing open-source codebase, especially with debugging, testing, and making focused changes. I am open to learning new tools or languages when the issue is well scoped.
